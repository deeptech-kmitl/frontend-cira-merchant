...
const CardPlan = () => {
  return (
    ...
    //                 {item.title}
    //               </h1>
    //               <div className="border-[#E5BD82] border-2 w-full xl:w-1/2">
    ...
    //             <div className="flex flex-col justify-between h-full px-6 border-l-2 border-l-[#E5BD82]">
    //               <div className="pt-2">
    ...
    //   ))}
    // </div>
    <div className="flex justify-center xl:mx-12 my-10 flex-col lg:flex-row">
      {data.map((item: plan, i: number) => (
        <div
          key={i}
          className={`bg-[#FFFFFF] max-w-[273px] mx-auto w-full shadow drop-shadow-xl overflow-hidden ${
            i == 2 ? 'scale-[110%]' : ''
          }`}
        >
          <div className="border-l-2 border-[#FFF2DE] p-6">
            ...
            <h1
              className={`text-[15px] text-[#D48A3A] ${
                i == 2 ? 'border-2 text-center w-1/2' : ''
              }`}
            >
              {item.subTitle}
            </h1>
