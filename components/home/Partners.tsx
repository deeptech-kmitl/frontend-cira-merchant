    ...
    <div className="w-full h-max mb-40 bg-[url('/images/hero_bg.png')]">
      <div className="flex flex-col space-y-12 justify-center">
        <div className="flex justify-center">
          <p className="w-1/3 text-center text-4xl font-bold bg-gradient-to-r from-[#9A5F06] via-[#BE911F] via-[#FCB040] to-[#E4D395] bg-clip-text text-transparent leading-[52px]">
