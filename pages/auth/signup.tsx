  ...
  return (
    <>
      <div className="w-full h-full flex items-start justify-between">
        <div className="w-1/2 h-full min-h-screen md:flex flex-auto items-center justify-center p-10 overflow-hidden bg-purple-900 text-white bg-no-repeat bg-cover relative test">
          <div className="absolute h-full bg-gradient-to-b from-indigo-600 to-blue-500 opacity-75 inset-0 z-0"></div>
        ...
        <div className="w-1/2 overflow-scroll min-h-screen p-20 bg-gray-50/10 flex flex-col justify-center items-center">
          <form>
            <div className="space-y-12">
                    ...
                    <div className="mt-2">
                      <div className="flex rounded-md shadow-sm ring-1 ring-inset ring-gray-300 focus-within:ring-2 focus-within:ring-inset focus-within:ring-indigo-600 sm:max-w-md">
                        <input
                          ...
                          className="pl-3 block flex-1 border-0 bg-transparent py-1.5 text-gray-900 placeholder:text-gray-400 focus:ring-0 sm:leading-6"
              ...
              <div className="border-b border-gray-900/10 pb-12">
                ...
                <div className="mt-10 space-y-10">
                  <fieldset>
                    <legend className=" font-semibold leading-6 text-gray-900">
                      By Email
                    </legend>
